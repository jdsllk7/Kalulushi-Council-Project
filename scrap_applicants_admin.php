<html lang="en">
  <head>
    ...
    <title>Scrap Metal Dealer Licence | Applicants</title>
      ...
      ?>
        ...
        <div class="row">
          ...
          <ul id='applicant_table' class="collection container with-header">
            <li class="collection-header"><h4><b>Scrap Metal Dealer Licence Applicants</b></h4></li>
            ...
            <tbody>
              <?php
                $sql = "SELECT scrap_form.form_status as form_status, users.id as id, users.business_name as business_name, users.tpin_number as tpin_number
                         FROM users INNER JOIN scrap_form 
                          ON users.id=scrap_form.user_id";
                ...
                if (mysqli_num_rows($result) > 0) {
                    while($row = mysqli_fetch_assoc($result)) {
                      ...
                      echo"<tr>
                        ...
                        <td><a class='table_links' href='scrap_form_admin.php?business_name=".$row["business_name"]."&id=".$row["id"]."'>Review</a></td>
                      </tr>";
                    }
                } else {
                  echo "<tr>
