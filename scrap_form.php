  ...
  <body class="white">
    ...
    <form class="row container" method="post" enctype="multipart/form-data"
      ...
      <div class="input-field col s10 m8 l6 offset-s1 offset-m2 offset-l3">
        <input id="for15" type="number" min='1' class="validate" value="<?php echo $street_no;?>" name="street_no" required>
      ...
      <div class="input-field col s10 m8 l6 offset-s1 offset-m2 offset-l3">
        <input id="for3" type="text" class="validate" value="<?php echo $status;?>" name="status" required>
      ...
      <div class="input-field col s6 offset-s3 center">
        <button name="scrap_form_btn" value="scrap_form_btn" class="waves-effect btn-large orange darken-4 waves-light" type="submit">Submit
